...
export const metadata: Metadata = {
  title: 'Disclaimer - MSpace Real Estate',
  description: 'Disclaimer for MSpace Real Estate - Important information about our services and limitations.',
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Any content submitted by users, including reviews, comments, or other materials, represents the views of the individual user and not necessarily the views of MSpace Real Estate. We are not responsible for the accuracy or reliability of user-generated content.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                In no event shall MSpace Real Estate, its officers, directors, employees, agents, or affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless MSpace Real Estate, its officers, directors, employees, agents, and affiliates from any claims, damages, losses, or expenses (including reasonable attorney's fees) arising from:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                MSpace Real Estate shall not be liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
